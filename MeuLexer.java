...
public MeuLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("para", this), new Integer(17));
	literals.put(new ANTLRHashString("declara", this), new Integer(5));
	...
	literals.put(new ANTLRHashString("fim", this), new Integer(9));
...
tryAgain:
	...
	public final void mT_dif(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = T_dif;
		int _saveIndex;
	...
	public final void mT_pontovirgula(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = T_pontovirgula;
		int _saveIndex;
